...
class Quiz:
    ...
    def buttons(self):
        ...
        width=10,bg="coral1",fg="mint cream",font=("cooper black",16,"italic"))
        ...
        width=5,bg="hotpink4", fg="white",font=("cooper black",16," bold"))
    ...
    def display_question(self):
        ...
        font=( 'spade' ,16, 'bold' ), anchor= 'w' )
         
        #placing the option on the screen
        q_no.place(x=30, y=90)
    ...
    def display_title(self):
        ...
        title = Label(gui, text="HOGWART'S QUIZ",
        width=40, bg="lightgoldenrod",fg="maroon1", font=("algerian", 25, "bold","italic"))
    ...
    def radio_buttons(self):
        ...
        while len(q_list) < 4:
            ...
            value = len(q_list)+1,font = ("spade",14))
