...
public class Question extends AbstractEntity {
	...
	public void autoGenerateId() {
		...
		super.setId(lastEntry);  //Passing lastEntry to setId of AbstractEntity class
	}
	 ...
	 */
	public String getTitle() {        // getter function to return brief description of question
	 ...
	 */
	public void setTitle(String title) {      // setter function to set the brief description of question
		// please write your code here
	 ...
	 */
	public String getMessage() {              //getter to return description of question
		// please write your code here
	 ...
	 */
	public void setMessage(String message) {         //setter to set the description of question
		// please write your code here
	 ...
	 */
	public User getUser() {                 // getter to return the user who asked the question
		// please write your code here
	 ...
	 */
	public void setUser(User user) {            //// setter to set the user who asked the question
		// please write your code here
	 ...
	 */
	public int getUpvoteCount() {      //getter to return the upvoteCount
		// please write your code here
	 ...
	 */
	public void increaseUpvoteCount() {    // method to count the upvote and incrementing by 1 each time call
