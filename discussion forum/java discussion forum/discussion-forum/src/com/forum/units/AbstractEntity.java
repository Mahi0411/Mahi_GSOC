...
public abstract class AbstractEntity {
	...
	public long getId() {      // getter to return the id of abstract entity
		return id;
	}
	...
	public void setId(long id) {           // setter to set the id of abstract entity
    ...
    public abstract void autoGenerateId();   // declaring the abstract method autoGenerateId
