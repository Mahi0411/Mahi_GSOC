...
public class Reply extends AbstractEntity {
	 ...
	 */
	public String getMessage() {       //getter to return the reply body
	 ...
	 */
	public void setMessage(String message) {            //setter to set the reply body
		// please write your code here
	 ...
	 */
	public User getUser() {       // getter to return the user who reply the question
		// please write your code here
	 ...
	 */
	public void setUser(User user) {        // setter to set the user who reply the question
		// please write your code here
	 ...
	 */
	public Question getQuestion() {     //getter to return the question which is reply by user
		// please write your code here
	 ...
	 */
	public void setQuestion(Question question) {  //setter to set the question which is reply by user
		// please write your code here
